...
void loop() {    
  ...
  //lectura de temperaturas
   ...
   if (diftime>=1000){
      ...
      t.cocina=analogRead(0)/10.0;
      t.living=analogRead(1)/10.0;
      t.dormitorio1=analogRead(2)/10.0;
      t.dormitorio2=analogRead(3)/10.0;
      
      Serial.print(" temp. cocina=");
      Serial.print(t.cocina);
      Serial.print(" temp. living=");
      Serial.print(t.living);
      Serial.print(" temp. dormitorio1=");
      Serial.print(t.dormitorio1);
      Serial.print(" temp. dormitorio2=");
      Serial.print(t.dormitorio2);
      Serial.println(" ");     
      contador=myTime;
    }
